...
work:
	ldr		x28, [sp, N]
	ldr		s0, [sp, buf]
	mov		x6, size //size of el
	mov		x27, #0 //element
	mov		x7, #0 //diagonal
	mul		x5, x28, x6 //size of line
0:
	add		x9, x7, #1
	cmp		x9, x28
	beq		5f
	...
	mul		x17, x7, x6
	add		x8, x8, x17
	add		x8, x8, buf //addres of main line
...
2:
	...
	cmp		x4, x28
	bge		4f
	//add		x2, x8, x5 //addres of the first el of the second line
	mul		x2, x4, x5
	add		x2, x2, x8
	ldr		s1, [sp, x2]
	fdiv		s3, s1, s0
...
0:
	...
	mul		x7, x27, x6
	add		x7, x7, x8
	add		x7, x7, buf//adres of my element
	ldr		s0, [x29, x7]
	mul		x15, x27, x6
	add		x4, x15, buf2
	ldr		s1, [x29, x4]
